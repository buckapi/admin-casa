...
export class DataApiService {
	...
	getAllCategory() {
		const url_api = this.yeoman.origin.restUrl + '/api/collections/casaCategories/records';
		return this.http.get(url_api);
	  }
	  getAllBrand(){
		const url_api = this.yeoman.origin.restUrl + '/api/collections/casaType/records';
		return this.http.get(url_api);
	  }
